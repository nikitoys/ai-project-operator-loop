# Codex Operator Commands — {{PROJECT_NAME}}

Short operator commands must be interpreted through `AI_PROJECT/CODEX_WORKFLOW.md`.

## Planning and State

- `Разобрать план` — read `AI_PROJECT/OWNER_PLAN.md`, compare it with current state and propose backlog/task updates without implementation.
...
- `Обновить AI-систему` — run project system update for the local control layer; do not modify application code.
- `Проверить обновление AI-системы` — report update/migration plan only.
