# Agent Tasks — Accepted Prerequisite Fixture

Status: Draft

## Purpose

Fixture for dependency-aware dry-run parallel group detection.
...
| AWP-BE-001 | ready | SOP-FEATURE-001 | Backend Developer AI | T-020 | FAST_VALIDATION | Backend planning can start after requirements. |
...
| AWP-QA-001 | ready | SOP-FEATURE-001 | QA Engineer AI | T-020 | FAST_VALIDATION | QA waits for backend and frontend planning. |
